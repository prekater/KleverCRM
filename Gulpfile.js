...
gulp.task('scripts', () => {
    ...
    return gulp.src(['./src/track-adding-release/scripts/index.js', './src/common/scripts/index.js', './src/common/scripts/jquery.nice-select.js'])
        // .pipe(uglify())
        ...
        //     };
        // }))
        .pipe(gulp.dest('./build/track-adding-release/scripts'));
});
gulp.task('images', () => {
