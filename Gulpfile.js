...
gulp.task('scripts', () => {
    ...
    return gulp.src(['./src/track-404/scripts/index.js', './src/common/scripts/index.js', './src/common/scripts/jquery.nice-select.js'])
        // .pipe(uglify())
        ...
        //     };
        // }))
        .pipe(gulp.dest('./build/track-404/scripts'));
});
gulp.task('images', () => {
