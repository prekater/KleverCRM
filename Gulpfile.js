...
gulp.task('start', gulp.series('scss', 'pug', 'images', 'common-images', 'fonts', 'moduleNiceSelect', 'scripts', 'moduleTableSorter', 'watch', 'browser'));
gulp.task('build', gulp.series('pug', 'images', 'common-images', 'fonts', 'moduleNiceSelect', 'scripts', 'moduleTableSorter', 'all-css', 'all-images', 'all-scripts', 'all-fonts'));